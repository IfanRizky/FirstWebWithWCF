...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <div>
        <asp:Button ID="Button1" runat="server" Text="Add" BackColor="#0099FF" ForeColor="White" Width="70px" OnClick="Button1_Click" />&nbsp
        <asp:Button ID="Button2" runat="server" Text="Sub" BackColor="#0099FF" ForeColor="White" Width="70px" OnClick="Button2_Click" />&nbsp
        <asp:Button ID="Button3" runat="server" Text="Multiple" BackColor="#0099FF" ForeColor="White" Width="70px" OnClick="Button3_Click" />&nbsp
        <asp:Button ID="Button4" runat="server" Text="Divide" BackColor="#0099FF" ForeColor="White" Width="70px" OnClick="Button4_Click" />&nbsp
    </div>
    <br />
    <div style="color:blue; font-size:medium; font-weight:bolder">
